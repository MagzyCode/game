...
{
    public class SpellPowerPrizeFactory : PrizeFactory
    {
        /// <summary>
        /// Подбираемые заряды
        /// </summary>
        ...
        public override GameObject CreatePrize(Vector2 position)
        {
            ...
            gameObject.InitializeObjectComponent(new SpriteComponent(RenderingSystem.LoadBitmap("Resources/MazeElements/Prize/spell_power.png")));
            ...
            speedPrize.InitializeWeaponSpawn(new PowerDecorator(new PlayerProperitiesStandart()), 50f);
